...
public class MainFunctionConstant {
	...
	public static List<MainFunction> getMainFunctionList(){
		...
		MainFunction mainFunction3 = new MainFunction(3, "群公告", R.drawable.menu_my_tax_list);
		MainFunction mainFunction4 = new MainFunction(4, "上传公告", R.drawable.menu_list_check);
